          ...
          <div className="about-block__content">
            ...
            <div className="about-services-accordion">
              <details>
                ...
                <p>Бесплатная доставка по Рязани и области. При выборе доставки согласуем удобное время прибытия, бережно доставим оборудование и поднимем на этаж. Также вы можете забрать заказ самостоятельно со склада — наш менеджер уточнит удобный для вас способ получения при оформлении.</p>
              </details>
              <details>
